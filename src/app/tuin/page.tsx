  ...
  return (
    <div className="h-screen flex flex-col">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Rechterpaneel: tabs */}
        <aside className="w-72 border-l bg-white hidden md:flex md:flex-col overflow-hidden">
          <Tabs defaultValue="toevoegen" className="flex flex-col h-full min-h-0">
            ...
            <TabsContent value="planning" className="flex flex-col flex-1 min-h-0 mt-0 data-[state=inactive]:hidden">
